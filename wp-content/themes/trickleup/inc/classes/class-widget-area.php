...
if ( ! class_exists( 'Trickleup_Widget_Area' ) ) {

	/**
	 * Class Trickleup_Widget_Area.
	 */
	class Trickleup_Widget_Area {
		...
		function __construct() {
			...
			add_action( 'trickleup_render_widget_area', array( $this, 'render' ) );
		}
		...
		public function render( $area_id ) {
			...
			$area_id        = apply_filters( 'trickleup_rendering_current_widget_area', $area_id );
			...
			$classes = apply_filters( 'trickleup_widget_area_classes', $classes, $area_id );
	 ...
	 * @return object
	 */
	function trickleup_widget_area() {
		return Trickleup_Widget_Area::get_instance();
	}

	trickleup_widget_area();
}
