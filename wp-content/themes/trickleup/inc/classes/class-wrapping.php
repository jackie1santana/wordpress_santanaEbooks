 ...
 */
add_filter( 'template_include', array( 'Trickleup_Wrapping', 'wrap' ), 99 );
add_filter( 'trickleup_wrap_base', 'trickleup_wrap_base_cpts' );
 ...
 */
function trickleup_template_path() {
	return Trickleup_Wrapping::$main_template;
}
 ...
 */
function trickleup_template_base() {
	return Trickleup_Wrapping::$base;
}

if ( ! class_exists( 'Trickleup_Wrapping' ) ) {
	...
	class Trickleup_Wrapping {
		...
		/**
		 * Initialize new instance of Trickleup_Wrapping class by setting a variable for the $slug (which defaults to base)
		...
		public function __toString() {
			$this->templates = apply_filters( 'trickleup_wrap_' . $this->slug, $this->templates );
		 ...
		 * and $base as static variables in Trickleup_Wrapping class.
		 *
		 * @since 1.0.0
 ...
 */
function trickleup_wrap_base_cpts( $templates ) {
