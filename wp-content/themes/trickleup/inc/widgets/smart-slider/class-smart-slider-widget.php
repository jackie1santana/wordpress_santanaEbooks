...
if ( ! class_exists( 'Trickleup_Smart_Slider_Widget' ) ) {

	/**
	 * Class Trickleup_Smart_Slider_Widget.
	 */
	class Trickleup_Smart_Slider_Widget extends Cherry_Abstract_Widget {
		...
		public function __construct() {
			...
			$this->widget_description = esc_html__( 'Display smart slider on your site.', 'trickleup' );
			$this->widget_id          = 'trickleup_widget_smart_slider';
			$this->widget_name        = esc_html__( 'Smart Slider', 'trickleup' );
			$this->utility            = trickleup_utility()->utility;
			$this->settings           = array(
				'title' => array(
					'type'  => 'text',
					'value' => '',
				...
				'terms_type' => array(
					...
					'options' => array(
						'category' => array(
							'label' => esc_html__( 'Category', 'trickleup' ),
							'slave' => 'terms_type_category',
						),
						'post_tag' => array(
							'label' => esc_html__( 'Tag', 'trickleup' ),
							'slave' => 'terms_type_post_tag',
						),
					),
					'label'   => esc_html__( 'Choose taxonomy type', 'trickleup' ),
				),
				'categories' => array(
					'type'             => 'select',
					'size'             => 1,
					...
					'options'          => false,
					'label'            => esc_html__( 'Select category', 'trickleup' ),
					'multiple'         => true,
					'placeholder'      => esc_html__( 'Select category', 'trickleup' ),
				...
				'tags' => array(
					...
					'options'          => false,
					'label'            => esc_html__( 'Select tags', 'trickleup' ),
					'multiple'         => true,
					'placeholder'      => esc_html__( 'Select tags', 'trickleup' ),
				...
				'posts_per_page' => array(
					...
					'max_value' => 50,
					'min_value' => 1,
					'label'     => esc_html__( 'Posts count', 'trickleup' ),
				),
				'post_title' => array(
					'type'  => 'switcher',
					'value' => 'true',
					'style' => ( wp_is_mobile() ) ? 'normal' : 'small',
					'label' => esc_html__( 'Display title', 'trickleup' ),
				),
				'content' => array(
					'type'  => 'switcher',
					'value' => 'false',
					'style' => ( wp_is_mobile() ) ? 'normal' : 'small',
					'label' => esc_html__( 'Display content', 'trickleup' ),
				),
				'more_button' => array(
					'type'   => 'switcher',
					'value'  => 'true',
					'style'  => ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'  => esc_html__( 'Display more button', 'trickleup' ),
					'toggle' => array(
						'true_toggle'  => esc_html__( 'On', 'trickleup' ),
						'false_toggle' => esc_html__( 'Off', 'trickleup' ),
				...
				'more_button_text' => array(
					'type'   => 'text',
					'value'  => esc_html__( 'Read more', 'trickleup' ),
					'label'  => esc_html__( 'More button text', 'trickleup' ),
				...
				'title_trim_words' => array(
					...
					'min_value'  => 1,
					'step_value' => 1,
					'label'      => esc_html__( 'Title words trimmed count', 'trickleup' ),
				),
				'trim_words' => array(
					'type'       => 'slider',
					'value'      => 15,
					...
					'min_value'  => 1,
					'step_value' => 1,
					'label'      => esc_html__( 'Content words trimmed count', 'trickleup' ),
				),
				'width' => array(
					'type'  => 'text',
					'value' => '100%',
					'label' => esc_html__( 'Slider width', 'trickleup' ),
				),
				'height' => array(
					'type'  => 'text',
					'value' => '800',
					'label' => esc_html__( 'Slider height', 'trickleup' ),
				),
				'orientation' => array(
					'type'    => 'select',
					'size'    => 1,
					'value'   => 'horizontal',
					'options' => array(
						'horizontal' => esc_html__( 'Horizontal', 'trickleup' ),
						'vertical'   => esc_html__( 'Vertical', 'trickleup' ),
					),
					'label'   => esc_html__( 'Slider orientation', 'trickleup' ),
				),
				'slide_distance' => array(
					...
					'max_value' => 100,
					'min_value' => 0,
					'label'     => esc_html__( 'Slide distance(px)', 'trickleup' ),
				),
				'slide_duration' => array(
					...
					'min_value'  => 100,
					'step_value' => 100,
					'label'      => esc_html__( 'Slide duration(ms)', 'trickleup' ),
				),
				'slide_fade' => array(
					'type'  => 'switcher',
					'value' => 'false',
					'style' => ( wp_is_mobile() ) ? 'normal' : 'small',
					'label' => esc_html__( 'Use fade effect?', 'trickleup' ),
				),
				'navigation' => array(
					'type'   => 'switcher',
					'value'  => 'true',
					'style'  => ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'  => esc_html__( 'Use navigation?', 'trickleup' ),
					'toggle' => array(
						'true_toggle'  => esc_html__( 'On', 'trickleup' ),
						'false_toggle' => esc_html__( 'Off', 'trickleup' ),
				...
				'fade_navigation' => array(
					...
					'value'  => 'true',
					'style'  => ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'  => esc_html__( 'Indicates whether the arrows will fade in only on hover', 'trickleup' ),
				...
				'pagination' => array(
					...
					'value' => 'true',
					'style' => ( wp_is_mobile() ) ? 'normal' : 'small',
					'label' => esc_html__( 'Use pagination?', 'trickleup' ),
				),
				'autoplay' => array(
					'type'  => 'switcher',
					'value' => 'true',
					'style' => ( wp_is_mobile() ) ? 'normal' : 'small',
					'label' => esc_html__( 'Use autoplay?', 'trickleup' ),
				),
				'fullScreen' => array(
					'type'  => 'switcher',
					'value' => 'false',
					'style' => ( wp_is_mobile() ) ? 'normal' : 'small',
					'label' => esc_html__( 'Display fullScreen button?', 'trickleup' ),
				),
				'shuffle' => array(
					'type'  => 'switcher',
					'value' => 'false',
					'style' => ( wp_is_mobile() ) ? 'normal' : 'small',
					'label' => esc_html__( 'Indicates if the slides will be shuffled', 'trickleup' ),
				),
				'loop' => array(
					'type'  => 'switcher',
					'value' => 'true',
					'style' => ( wp_is_mobile() ) ? 'normal' : 'small',
					'label' => esc_html__( 'Use infinite scrolling?', 'trickleup' ),
				),
				'thumbnails' => array(
					'type'   => 'switcher',
					'value'  => 'false',
					'style'  => ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'  => esc_html__( 'Display thumbnails?', 'trickleup' ),
					'toggle' => array(
						'true_toggle'  => esc_html__( 'On', 'trickleup' ),
						'false_toggle' => esc_html__( 'Off', 'trickleup' ),
				...
				'thumbnails_position' => array(
					...
					'options' => array(
						...
						'bottom' => esc_html__( 'Bottom', 'trickleup' ),
						'right'  => esc_html__( 'Right', 'trickleup' ),
						'left'   => esc_html__( 'Left', 'trickleup' ),
					),
					'label'   => esc_html__( 'Sets the position of the thumbnail scroller', 'trickleup' ),
				...
				'thumbnails_arrows' => array(
					...
					'value'  => 'true',
					'style'  => ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'  => esc_html__( 'Display thumbnails arrows?', 'trickleup' ),
					'master' => 'thumbnails_attr',
				),
			);
		...
		public function widget( $args, $instance ) {
			...
			if ( $posts_query ) {
				...
				$html = '<h4>' . esc_html__( 'Posts for slider not found', 'trickleup' ) . '</h4>';
			}
		...
		public function render_slider( $posts_query ) {
			...
			$html = '<div class="trickleup-smartslider smart-slider__instance invert" ' . $slider_html_attr . '>';
		...
		public function get_query_slider_items( $query_args = array() ) {
			...
			$defaults_query_args = apply_filters( 'trickleup_smart_slider_default_query_args', array(
				'post_type'           => 'post',
				'orderby'             => 'date',
				'order'               => 'DESC',
				'posts_per_page'      => - 1,
		...
		public function get_slider_loop( $posts_query ) {
			 ...
			 * @var  array
			 */
			$title_settings = apply_filters( 'trickleup_smart_slider_title_settings', array(
				'width'           => '100%%',
				'horizontal'      => '0%%',
				'vertical'        => '38%%',
			 ...
			 * @var  array
			 */
			$content_settings = apply_filters( 'trickleup_smart_slider_content_settings', array(
				'width'           => '100%%',
				'horizontal'      => '5%%',
				'vertical'        => '51%%',
				'show_transition' => 'left',
			 ...
			 * @var  array
			 */
			$more_settings = apply_filters( 'trickleup_smart_slider_more_button_settings', array(
				'width'           => '100%%',
				'horizontal'      => '5%%',
				'vertical'        => '58%%',
				'show_transition' => 'left',
			...
			while ( $posts_query->have_posts() ) : $posts_query->the_post();
				...
				$html .= '<div class="smart-slider__item sp-slide">';
					$html .= $this->utility->media->get_image( array(
						'size'        => 'trickleup-thumb-xl',
						'mobile_size' => 'trickleup-thumb-l',
						'class'       => 'sp-image',
		...
		public function get_slider_thumbnails( $posts_query ) {
			...
			while ( $posts_query->have_posts() ) : $posts_query->the_post();
				$html .= '<div class="sp-thumbnail">';
					$html .= $this->utility->media->get_image( array(
						'size'        => 'trickleup-slider-thumb',
						'mobile_size' => 'trickleup-slider-thumb',
	...
	add_action( 'widgets_init', 'trickleup_register_smart_slider_widgets' );
	/**
	 * Register Smart slider widget.
	 */
	function trickleup_register_smart_slider_widgets() {
		register_widget( 'Trickleup_Smart_Slider_Widget' );
	}
}
