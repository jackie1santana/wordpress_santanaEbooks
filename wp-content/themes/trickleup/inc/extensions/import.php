...
add_action( 'cherry_data_import_home_regex_replace', 'trickleup_remap_shortcodes' );
add_action( 'cherry_data_import_remap_posts',        'trickleup_remap_menus' );
add_action( 'cherry_data_import_remap_posts',        'trickleup_remap_timetable' );
 ...
 * @return array
 */
function trickleup_remap_shortcodes( $regex ) {
 ...
 */
function trickleup_remap_timetable( $posts ) {
 ...
 * @param array $posts post remapping array.
 */
function trickleup_remap_menus( $posts ) {
