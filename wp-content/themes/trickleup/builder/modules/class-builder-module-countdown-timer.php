...
/**
 * Class Trickleup_Builder_Module_Countdown_Timer.
 */
class Trickleup_Builder_Module_Countdown_Timer extends Tm_Builder_Module {

	public $function_name;

	public function init() {
		$this->name = esc_html__( 'Countdown Timer', 'trickleup' );
		...
		$this->advanced_options = array(
			'fonts' => array(
				'header' => array(
					'label'    => esc_html__( 'Header', 'trickleup' ),
					'css'      => array(
						'main' => "{$this->main_css_element} h4",
					),
				),
				'numbers' => array(
					'label'    => esc_html__( 'Numbers', 'trickleup' ),
					'css'      => array(
				...
				'label' => array(
					'label'    => esc_html__( 'Label', 'trickleup' ),
					'css'      => array(
		...
		$this->custom_css_options = array(
			'container' => array(
				'label'    => esc_html__( 'Container', 'trickleup' ),
			...
			'timer_section' => array(
				'label'    => esc_html__( 'Timer Section', 'trickleup' ),
				'selector' => '.section',
			),
		);
	}
	...
	public function get_fields() {
		$fields = array(
			'title' => array(
				'label'           => esc_html__( 'Countdown Timer Title', 'trickleup' ),
				'type'            => 'text',
				'option_category' => 'basic_option',
				'description'     => esc_html__( 'This is the title displayed for the countdown timer.', 'trickleup' ),
			),
			'date_time' => array(
				'label'           => esc_html__( 'Countdown To', 'trickleup' ),
				'type'            => 'date_picker',
				'option_category' => 'basic_option',
				'description'     => tm_get_safe_localization(
					sprintf(
						...
						esc_html__( 'This is the date the countdown timer is counting down to. Your countdown timer is based on your timezone settings in your ', 'trickleup' ),
						esc_html__( 'WordPress General Settings', 'trickleup' )
					)
				),
			),
			'use_background_color' => array(
				'label'           => esc_html__( 'Use Background Color', 'trickleup' ),
				'type'            => 'yes_no_button',
				...
				'description' => esc_html__( 'Here you can choose whether background color setting below should be used or not.', 'trickleup' ),
			),
			'background_color' => array(
				'label'             => esc_html__( 'Background Color', 'trickleup' ),
				'type'              => 'color-alpha',
				'depends_default'   => true,
				'description'       => esc_html__( 'Here you can define a custom background color for your countdown timer.', 'trickleup' ),
			),
			'timer_layout' => array(
				'label'             => esc_html__( 'Layout', 'trickleup' ),
				'type'              => 'select',
				'options'           => array(
					'flat'   => esc_html__( 'Flat', 'trickleup' ),
					'circle' => esc_html__( 'Circle', 'trickleup' ),
				),
				'affects'           => array(
			...
			'circle_background' => array(
				'label'               => esc_html__( 'Circle Background Color', 'trickleup' ),
				'type'                => 'color-alpha',
			...
			'use_circle_border' => array(
				'label'           => esc_html__( 'Use Circle Border', 'trickleup' ),
				'type'            => 'yes_no_button',
...
new Trickleup_Builder_Module_Countdown_Timer;
