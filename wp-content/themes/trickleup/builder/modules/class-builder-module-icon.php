 ...
 */
class Trickleup_Builder_Module_Icon extends Tm_Builder_Module {

	public $function_name;

	public function init() {
		$this->name = esc_html__( 'Icon', 'trickleup' );
		$this->icon = 'f1d8';
	...
	public function get_fields() {
		...
		$fields = array(
			'font_icon' => array(
				'label'               => esc_html__( 'Icon', 'trickleup' ),
				'type'                => 'text',
				'option_category'     => 'basic_option',
				'class'               => array( 'tm-pb-font-icon' ),
				'renderer'            => 'tm_pb_get_font_icon_list',
				'renderer_with_field' => true,
				'description'         => esc_html__( 'Choose an icon to display.', 'trickleup' ),
			),
			'icon_color' => array(
				'label'       => esc_html__( 'Icon Color', 'trickleup' ),
				'type'        => 'color-alpha',
				'description' => esc_html__( 'Here you can define a custom color for your icon.', 'trickleup' ),
			),
			'use_circle' => array(
				'label'           => esc_html__( 'Circle Icon', 'trickleup' ),
				'type'            => 'yes_no_button',
				'option_category' => 'configuration',
				'options'         => array(
					'off' => esc_html__( 'No', 'trickleup' ),
					'on'  => esc_html__( 'Yes', 'trickleup' ),
				),
				'affects'         => array(
				...
				'description'     => esc_html__( 'Here you can choose whether icon set above should display within a circle.', 'trickleup' ),
			),
			'circle_color' => array(
				'label'       => esc_html__( 'Circle Color', 'trickleup' ),
				'type'        => 'color-alpha',
				'description' => esc_html__( 'Here you can define a custom color for the icon circle.', 'trickleup' ),
			),
			'use_circle_border' => array(
				'label'           => esc_html__( 'Show Circle Border', 'trickleup' ),
				'type'            => 'yes_no_button',
				...
				'description'     => esc_html__( 'Here you can choose whether if the icon circle border should display.', 'trickleup' ),
			),
			'circle_border_color' => array(
				'label'       => esc_html__( 'Circle Border Color', 'trickleup' ),
				'type'        => 'color-alpha',
				'description' => esc_html__( 'Here you can define a custom color for the icon circle border.', 'trickleup' ),
			),
			'animation' => array(
				'label'           => esc_html__( 'Icon Animation', 'trickleup' ),
				'type'            => 'select',
				'option_category' => 'configuration',
				'options'         => array(
					'top'    => esc_html__( 'Top To Bottom', 'trickleup' ),
					'left'   => esc_html__( 'Left To Right', 'trickleup' ),
					'right'  => esc_html__( 'Right To Left', 'trickleup' ),
					'bottom' => esc_html__( 'Bottom To Top', 'trickleup' ),
					'off'    => esc_html__( 'No Animation', 'trickleup' ),
				),
				'description'     => esc_html__( 'This controls the direction of the lazy-loading animation.', 'trickleup' ),
			),
			'icon_orientation' => array(
				'label'           => esc_html__( 'Icon Orientation', 'trickleup' ),
				'type'            => 'select',
				'option_category' => 'layout',
				'options'         => array(
				...
				'description'     => esc_html__( 'This will control how your icon is aligned.', 'trickleup' ),
			),
			'use_icon_font_size' => array(
				'label'           => esc_html__( 'Use Icon Font Size', 'trickleup' ),
				'type'            => 'yes_no_button',
			...
			'icon_font_size' => array(
				'label'           => esc_html__( 'Icon Font Size', 'trickleup' ),
				'type'            => 'range',
				'option_category' => 'font_option',
				'tab_slug'        => 'advanced',
				'default'         => '50px',
			...
			'circle_size' => array(
				'label'           => esc_html__( 'Circle Size', 'trickleup' ),
				'type'            => 'range',
				'option_category' => 'layout',
				'tab_slug'        => 'advanced',
				'default'         => '100',
				...
				'description'     => esc_html__( 'Here you can define a custom diameter for the icon circle.', 'trickleup' ),
				'mobile_options'  => true,
				'depends_default' => true,
			),
			'circle_border_width' => array(
				'label'           => esc_html__( 'Circle Border Width', 'trickleup' ),
				'type'            => 'range',
				'option_category' => 'layout',
				'tab_slug'        => 'advanced',
				'default'         => '2',
				...
				'description'     => esc_html__( 'Here you can define a custom width for the icon circle border.', 'trickleup' ),
				'depends_default' => true,
			),
			...
			'disabled_on' => array(
				'label'           => esc_html__( 'Disable on', 'trickleup' ),
				'type'            => 'multiple_checkboxes',
				'options'         => tm_pb_media_breakpoints(),
				'additional_att'  => 'disable_on',
				'option_category' => 'configuration',
				'description'     => esc_html__( 'This will disable the module on selected devices', 'trickleup' ),
			),
			'admin_label' => array(
				'label'       => esc_html__( 'Admin Label', 'trickleup' ),
				'type'        => 'text',
				'description' => esc_html__( 'This will change the label of the module in the builder for easy identification.', 'trickleup' ),
			),
			'module_id' => array(
				'label'           => esc_html__( 'CSS ID', 'trickleup' ),
				'type'            => 'text',
				'option_category' => 'configuration',
				'tab_slug'        => 'custom_css',
			...
			'module_class' => array(
				'label'           => esc_html__( 'CSS Class', 'trickleup' ),
				'type'            => 'text',
				'option_category' => 'configuration',
				'tab_slug'        => 'custom_css',
				'option_class'    => 'tm_pb_custom_css_regular',
...
new Trickleup_Builder_Module_Icon;
