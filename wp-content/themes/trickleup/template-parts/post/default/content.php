...
<article id="post-<?php the_ID(); ?>" <?php post_class( 'posts-list__item card' ); ?>>
	...
	$size                = trickleup_post_thumbnail_size( array( 'class_prefix' => 'post-thumbnail--' ) );
	?>
	...
	<div class="post-list__item-content">
		...
		<div class="entry-content">
			<?php $blog_content = get_theme_mod( 'blog_posts_content', trickleup_theme()->customizer->get_default( 'blog_posts_content' ) );
		...
		<footer class="entry-footer">
			...
			<?php trickleup_share_buttons( 'loop' ); ?>

			<?php $btn_text = get_theme_mod( 'blog_read_more_text', trickleup_theme()->customizer->get_default( 'blog_read_more_text' ) );
