...
<div class="single-modern-header <?php echo $invert_class = has_post_thumbnail() ? 'invert' : ''; ?>">
	...
	<div class="post-thumbnail">
		<?php $utility->media->get_image( array(
			...
			'mobile_size' => 'trickleup-thumb-xl',
	...
	<div class="container">
		...
		<header class="entry-header">
			...
			<?php $author_visible = trickleup_is_meta_visible( 'single_post_author', 'single' );
		...
		<?php if ( 'post' === get_post_type() ) : ?>
			...
			<div class="entry-meta">
				...
				<?php $date_visible = trickleup_is_meta_visible( 'single_post_publish_date', 'single' );
				...
				<?php $comment_visible = trickleup_is_meta_visible( 'single_post_comments', 'single' );
				...
				<?php $cats_visible = trickleup_is_meta_visible( 'single_post_categories', 'single' );
				...
				<?php $tags_visible = trickleup_is_meta_visible( 'single_post_tags', 'single' );
